...
public class DKX003R_U {
	 ...
	 * @return
	 */
	public boolean isValidInput(DkxstdDao dao, String user, String mode ){
		boolean retval = true;
	 ...
	 * @return
	 */
	public boolean isValidInputForDelete(DkxstdDao dao, String user, String mode){
		boolean retval = true;
		if( (user!=null && !"".equals(user)) && (mode!=null && !"".equals(mode)) ){
			//check dao
			if( (dao.getThavd()!=null && !"".equals(dao.getThavd())) ){	
	 ...
	 * @param dao
	 */
	public void adjustNumericFields(DkxstdDao dao){
		String ZERO = "0";
		//TRUSTD
		//Decimals
	 ...
	 * @param errorStackTrace
	 */
	public boolean vaidateExchangesId(DkxstdDao dao){
		boolean retval = true;
