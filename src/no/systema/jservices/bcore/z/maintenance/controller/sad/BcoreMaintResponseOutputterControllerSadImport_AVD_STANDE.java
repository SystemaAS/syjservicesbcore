...
@Controller
public class BcoreMaintResponseOutputterControllerSadImport_AVD_STANDE {
	private static Logger logger = Logger.getLogger(BcoreMaintResponseOutputterControllerSadImport_AVD_STANDE.class.getName());
