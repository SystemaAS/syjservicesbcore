...
public class BcoreMaintResponseOutputterControllerSkatNctsImport_AVD_DKNSTD {
	private static Logger logger = LoggerFactory.getLogger(BcoreMaintResponseOutputterControllerSkatNctsImport_AVD_DKNSTD.class.getName());
	...
	public DknstdDaoServices getDknstdDaoServices(){ return this.dknstdDaoServices; }
