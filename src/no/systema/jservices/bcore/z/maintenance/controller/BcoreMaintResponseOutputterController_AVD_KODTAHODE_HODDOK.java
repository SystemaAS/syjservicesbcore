...
@Controller
public class BcoreMaintResponseOutputterController_AVD_KODTAHODE_HODDOK {
	private static Logger logger = LoggerFactory.getLogger(BcoreMaintResponseOutputterController_AVD_KODTAHODE_HODDOK.class.getName());
	...
	//WIRED SERVICES
	//----------------
	@Qualifier ("kodtaHodeDaoServices")
	private KodtaHodeDaoServices kodtaHodeDaoServices;
	@Autowired
	@Required
