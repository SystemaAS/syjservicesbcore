...
import no.systema.jservices.bcore.z.maintenance.model.dao.mapper.tds.SvxstdMapper;
 ...
 * 
 */
public class SvxstdDaoServicesImpl implements SvxstdDaoServices {
	private static Logger logger = LoggerFactory.getLogger(SvxstdDaoServicesImpl.class.getName());
	...
	public List getList(StringBuffer errorStackTrace){
		List<SvxstdDao> retval = new ArrayList<SvxstdDao>();
		
		try{
			StringBuffer sql = new StringBuffer();
			sql.append(this.getSELECT_FROM_CLAUSE());
			
			retval = this.jdbcTemplate.query( sql.toString(), new SvxstdMapper());
	...
	public List findById (String id, StringBuffer errorStackTrace ){
		...
		try{
			...
			retval = this.jdbcTemplate.query( sql.toString(), new Object[] { id }, new SvxstdMapper());
	...
	public int insert(Object daoObj, StringBuffer errorStackTrace){
		...
		try{
			...
			StringBuffer sql = new StringBuffer();
			/* TODO
			sql.append(" INSERT INTO svxstd ( thavd, thnttd, thntll, thfmll, thenkl, thtdn, s0004, s0010, s0026, s0035, thekst, ");
	...
	private String getSELECT_FROM_CLAUSE(){
		...
		sql.append(" from svxstd a, kodta b, cundf c  ");
