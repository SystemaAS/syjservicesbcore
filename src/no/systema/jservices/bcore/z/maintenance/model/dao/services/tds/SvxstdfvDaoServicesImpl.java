...
import no.systema.jservices.bcore.z.maintenance.model.dao.mapper.tds.SvxstdfvMapper;
 ...
 * 
 */
public class SvxstdfvDaoServicesImpl implements SvxstdfvDaoServices {
	private static Logger logger = LoggerFactory.getLogger(SvxstdfvDaoServicesImpl.class.getName());
	...
	public List getList(StringBuffer errorStackTrace){
		List<SvxstdfvDao> retval = new ArrayList<SvxstdfvDao>();
		
		try{
			StringBuffer sql = new StringBuffer();
			sql.append(this.getSELECT_FROM_CLAUSE());
			
			retval = this.jdbcTemplate.query( sql.toString(), new SvxstdfvMapper());
	...
	public List findById (String id, StringBuffer errorStackTrace ){
		...
		try{
			...
			retval = this.jdbcTemplate.query( sql.toString(), new Object[] { id }, new SvxstdfvMapper());
	...
	public int insert(Object daoObj, StringBuffer errorStackTrace){
		...
		try{
			...
			SvxstdfvDao dao = (SvxstdfvDao)daoObj;
			StringBuffer sql = new StringBuffer();
			
			sql.append(" INSERT INTO svxstdfv ( thavd, thsik, thdta, thtma, thkref, thtref, thspom, thtkbm, thlosd, thlosdsk, ");
	...
	public int update(Object daoObj, StringBuffer errorStackTrace){
		...
		try{
			...
			sql.append(" UPDATE svxstdfv SET thsik = ?, thdta = ?, thtma = ?, thkref = ?, thtref = ?, thspom = ?, thtkbm = ?, thlosd = ?, thlosdsk = ?,  ");
			sql.append(" thlkr1 = ?, thlkr2 = ?, thlkr3 = ?, thlkr4 = ?, thlkr5 = ?, thlkr6 = ?, thlkr7 = ?, thlkr8 = ?, ");
			sql.append(" thknss = ?, thnass = ?, thtinss = ?, thadss1 = ?, thskss = ?, thpsss = ?, thpnss = ?, thlkss = ?, ");
			sql.append(" thknks = ?, thnaks = ?, thtinks = ?, thadks1 = ?, thskks = ?, thpsks = ?, thpnks = ?, thlkks = ?, ");
			sql.append(" thknt = ?, thnat = ?, thtint = ?, thadt1 = ?, thskt = ?, thpst = ?, thpnt = ?, thlkt = ? ");
	...
	public int delete(Object daoObj, StringBuffer errorStackTrace){
		...
		try{
			...
			StringBuffer sql = new StringBuffer();
			//DEBUG --> logger.info("mydebug");
			sql.append(" DELETE from svxstdfv ");
			sql.append(" WHERE thavd = ? ");
	...
	private String getSELECT_FROM_CLAUSE(){
		...
		sql.append(" select d.* ");
		sql.append(" from svxstd a, kodta b, cundf c, svxstdfv d  ");
