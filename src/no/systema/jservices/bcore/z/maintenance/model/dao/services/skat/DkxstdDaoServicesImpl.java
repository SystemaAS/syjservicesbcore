...
import no.systema.jservices.bcore.z.maintenance.model.dao.mapper.skat.DkxstdMapper;
 ...
 * 
 */
public class DkxstdDaoServicesImpl implements DkxstdDaoServices {
	private static Logger logger = LoggerFactory.getLogger(DkxstdDaoServicesImpl.class.getName());
	...
	public List getList(StringBuffer errorStackTrace){
		List<DkxstdDao> retval = new ArrayList<DkxstdDao>();
		
		try{
			StringBuffer sql = new StringBuffer();
			sql.append(this.getSELECT_FROM_CLAUSE());
			
			retval = this.jdbcTemplate.query( sql.toString(), new DkxstdMapper());
	...
	public List findById (String id, StringBuffer errorStackTrace ){
		...
		try{
			...
			retval = this.jdbcTemplate.query( sql.toString(), new Object[] { id }, new DkxstdMapper());
	...
	public int insert(Object daoObj, StringBuffer errorStackTrace){
		...
		try{
			...
			DkxstdDao dao = (DkxstdDao)daoObj;
			StringBuffer sql = new StringBuffer();
			
			sql.append(" INSERT INTO dkxstd ( thavd, thnttd, thntll, thfmll, thenkl, thtdn, s0004, s0010, s0026, s0035, thekst, ");
	...
	private String getSELECT_FROM_CLAUSE(){
		...
		sql.append(" from dkxstd a, kodta b, cundf c  ");
