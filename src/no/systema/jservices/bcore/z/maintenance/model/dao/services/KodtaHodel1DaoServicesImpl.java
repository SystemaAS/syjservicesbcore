...
import no.systema.jservices.bcore.z.maintenance.model.dao.mapper.KodtaHodel1Mapper;
 ...
 * 
 */
public class KodtaHodel1DaoServicesImpl implements KodtaHodel1DaoServices {
	private static Logger logger = Logger.getLogger(KodtaHodel1DaoServicesImpl.class.getName());
	...
	public List getList(StringBuffer errorStackTrace){
		List<KodtaHodel1Dao> retval = new ArrayList<KodtaHodel1Dao>();
		try{
			StringBuffer sql = new StringBuffer();
			sql.append(this.getSELECT_CLAUSE());
			
			retval = this.jdbcTemplate.query( sql.toString(), new KodtaHodel1Mapper());
	...
	public List findById (String id, StringBuffer errorStackTrace ){
		...
		try{
			...
			retval = this.jdbcTemplate.query( sql.toString(), new Object[] { id }, new KodtaHodel1Mapper());
	...
	private String getSELECT_CLAUSE(){
		...
		sql.append(" full outer join hodel1 AS b ");
