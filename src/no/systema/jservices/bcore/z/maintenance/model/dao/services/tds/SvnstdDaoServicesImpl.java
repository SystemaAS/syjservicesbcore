...
import no.systema.jservices.bcore.z.maintenance.model.dao.mapper.tds.SvnstdMapper;
 ...
 * 
 */
public class SvnstdDaoServicesImpl implements SvnstdDaoServices {
	private static Logger logger = LoggerFactory.getLogger(SvnstdDaoServicesImpl.class.getName());
	...
	public List getList(StringBuffer errorStackTrace){
		List<SvnstdDao> retval = new ArrayList<SvnstdDao>();
		
		try{
			StringBuffer sql = new StringBuffer();
			sql.append(this.getSELECT_FROM_CLAUSE());
			
			retval = this.jdbcTemplate.query( sql.toString(), new SvnstdMapper());
	...
	public List findById (String id, StringBuffer errorStackTrace ){
		...
		try{
			...
			retval = this.jdbcTemplate.query( sql.toString(), new Object[] { id }, new SvnstdMapper());
	...
	public int insert(Object daoObj, StringBuffer errorStackTrace){
		...
		try{
			...
			SvnstdDao dao = (SvnstdDao)daoObj;
			StringBuffer sql = new StringBuffer();
			
			sql.append(" INSERT INTO svnstd ( tiavd, tist, tisg, titdn, tidt, tienkl, titrnr, tign, tignsk,  ");
			...
			sql.append(" s0035, s0026, tidk, tikna, tinaa, tiada1, tipna, tipsa, ");
			...
			retval = this.jdbcTemplate.update( sql.toString(), new Object[] { dao.getTiavd(), 
				...
				dao.getS0035(), dao.getS0026(), dao.getTidk(), dao.getTikna(), dao.getTinaa(), dao.getTiada1(), dao.getTipna(), dao.getTipsa(),
	...
	public int update(Object daoObj, StringBuffer errorStackTrace){
		...
		try{
			...
			sql.append(" UPDATE svnstd SET tist = ?, tisg = ?, titdn = ?, tidt = ?, tienkl = ?, titrnr = ?, tign = ?, tignsk = ?, ");
			sql.append(" tialsk = ?, tials = ?, tialss = ?, tiglsk = ?, tiacts = ?, tiskb = ?, titsb = ?, titarf = ?, tiws = ?, ");
			sql.append(" tikn = ?, tina = ?, tiad1 = ?, tipn = ?, tips = ?, tilk = ?, tisk = ?, titin = ?, s0004 = ?, s0010 = ?, ");
			sql.append(" s0035 = ?, s0026 = ?, tidk = ?, tikna = ?, tinaa = ?, tiada1 = ?, tipna = ?, tipsa = ?, ");
			sql.append(" tilka = ?, tiska = ?, titina = ?, tikns = ?, tinas = ?, tiads1 = ?, tipns = ?, tipss = ?, tilks = ?, tisks = ?, ");
			...
			retval = this.jdbcTemplate.update( sql.toString(), new Object[] { 
				...
				dao.getS0004(),dao.getS0010(),dao.getS0035(), dao.getS0026(), dao.getTidk(), dao.getTikna(), dao.getTinaa(), dao.getTiada1(), dao.getTipna(), dao.getTipsa(),
				dao.getTilka(), dao.getTiska(), dao.getTitina(), dao.getTikns(), dao.getTinas(), dao.getTiads1(), dao.getTipns(), dao.getTipss(), dao.getTilks(), dao.getTisks(), 
				dao.getTitins(), dao.getTiknk(), dao.getTinak(), dao.getTiadk1(), dao.getTipnk(), dao.getTipsk(), dao.getTilkk(), dao.getTiskk(), dao.getTitink(), dao.getTiblk(),
				dao.getTialk(), dao.getTitaid(), dao.getTitask(), dao.getTitalk(), dao.getTikdc(), dao.getTitrdt(), dao.getTilstl(), dao.getTivpos(), dao.getTintk(), dao.getTivkb(),
				dao.getTicats(), dao.getTictl(), dao.getTidant(), dao.getTidfkd(), dao.getTidfsk(), dao.getTituid(), dao.getTisgdk(), dao.getTisgme(), dao.getTisgut(), dao.getTisgid(),
	...
	private String getSELECT_FROM_CLAUSE(){
		...
		sql.append(" from svnstd a, kodta b, cundf c  ");
