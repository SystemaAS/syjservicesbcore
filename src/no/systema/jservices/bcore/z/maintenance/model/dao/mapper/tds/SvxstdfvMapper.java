 ...
 * @date  Oct 3, 2016
 * Säkerhet child record
 * 
 */
public class SvxstdfvMapper implements RowMapper {
	private static Logger logger = LoggerFactory.getLogger(SvxstdfvMapper.class.getName());
