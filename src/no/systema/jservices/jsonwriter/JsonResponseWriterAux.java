...
public class JsonResponseWriterAux {
	...
	private static Logger logger = Logger.getLogger(JsonResponseWriterAux.class.getName());
	...
	public String setJsonResult_Common_GetList(String user, List<IDao> list ){
		...
		for(IDao record : list){
			...
			//doIt
			sb.append(new JsonWriterReflectionManagerAux().getGettersFromRecord(record));
			//close the list
	...
	public String setJsonResult_Common_GetCompositeList(String user, List<IDao> list ){
		...
		for(IDao record : list){
			...
			sb.append(JsonConstants.JSON_OPEN_LIST_RECORD);
			//doIt
			sb.append(new JsonWriterReflectionManagerAux().getGettersFromRecordExtended(record));
			//close the list
			sb.append(JsonConstants.JSON_CLOSE_LIST_RECORD);
			counter++;
		}
