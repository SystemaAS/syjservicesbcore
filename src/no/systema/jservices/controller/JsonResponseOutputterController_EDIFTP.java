...
public class JsonResponseOutputterController_EDIFTP {
	private static Logger logger = Logger.getLogger(JsonResponseOutputterController_EDIFTP.class.getName());
	 ...
	 * 
	 * @return
	 * @Example SELECT *: http://gw.systema.no:8080/syjservicesbcore/syjsEDI42R.do?user=OSCAR
	 * @Example SELECT specific: http://gw.systema.no:8080/syjservicesbcore/syjsEDI42R.do?user=OSCAR&sssn=123
	 * 
	 */
	 ...
	 * @return
	 * 
	 * @Example SELECT *: http://gw.systema.no:8080/syjservicesbcore/syjsEDI43R.do?user=OSCAR
	 * @Example SELECT specific: http://gw.systema.no:8080/syjservicesbcore/syjsEDI43R.do?user=OSCAR&ssssn=123&sssdt=20160515&ssstm=131027
	 * 
	 */
